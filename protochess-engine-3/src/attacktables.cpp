...
namespace protochess_engine {
    AttackTables::AttackTables(Dimensions dimensions) : dimensions(dimensions) {
        ...
        bitboard cumulativeLeft;
        bitboard cumulativeRight;
        ...
        //Initialize attacks
        northAttacks.assign(numBits, bitboard());
        eastAttacks.assign(numBits, bitboard());
        southAttacks.assign(numBits, bitboard());
        westAttacks.assign(numBits, bitboard());
        northEastAttacks.assign(numBits, bitboard());
        northWestAttacks.assign(numBits, bitboard());
        southEastAttacks.assign(numBits, bitboard());
        southWestAttacks.assign(numBits, bitboard());
